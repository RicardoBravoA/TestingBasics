package com.udacity.testing.basics.tasks
...
class TasksViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _openTaskEvent = MutableLiveData<SingleEvent<String>>()
    val openTaskEvent: LiveData<SingleEvent<String>> = _openTaskEvent

    private val _newTaskEvent = MutableLiveData<SingleEvent<Unit>>()
    val newTaskEvent: LiveData<SingleEvent<Unit>> = _newTaskEvent
     ...
     */
    fun addNewTask() {
        _newTaskEvent.value = SingleEvent(Unit)
    }
    ...
    fun openTask(taskId: String) {
        _openTaskEvent.value = SingleEvent(taskId)
    }
    ...
    private fun filterTasks(tasksResult: TaskResult<List<Task>>): LiveData<List<Task>> {
