...
class StatisticsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val tasks: LiveData<TaskResult<List<Task>>> = tasksRepository.observeTasks()
    ...
    val empty: LiveData<Boolean> = tasks.map { (it as? TaskResult.Success)?.data.isNullOrEmpty() }
