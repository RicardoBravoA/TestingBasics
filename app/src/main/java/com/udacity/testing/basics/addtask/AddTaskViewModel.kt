...
class AddTaskViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _taskUpdatedEvent = MutableLiveData<SingleEvent<Unit>>()
    val taskUpdatedEvent: LiveData<SingleEvent<Unit>> = _taskUpdatedEvent
    ...
    fun saveTask() {
        ...
        if (currentTitle == null || currentDescription == null) {
            _snackbarText.value = SingleEvent(R.string.empty_task_message)
            return
        }
    ...
    private fun createTask(newTask: Task) = viewModelScope.launch {
        ...
        _taskUpdatedEvent.value = SingleEvent(Unit)
    }
